...
export const OctopusDeployTransformation = ({ entities, transformation, setTransformation }: Props) => {
      ...
      children: (
        <>
          ...
          <p style={{ marginBottom: 16 }}>
            Use Regular Expressions to define how DevLake identifies deployments and production environments from Octopus Deploy
